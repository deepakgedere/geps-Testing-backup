...
public class LPrCreate {
    public static final String REQUISITION_NAV = "#ni-requisitions";
    ...
    public static final String BOP_RADIO = "//input[@id='boPrcItmSelectionId']";
    public static final String YHW_RADIO = "//input[@id='hwItemsId']";
    public static final String YSW_RADIO = "//input[@id='swItemsId']";
    public static final String YPCI_RADIO = "//input[@id='pcItemsId']";
    ...
    public static final String INCOTERM_DROPDOWN = "#select2-incoterm-container";
    public static final String INCOTERM_SEARCH = ".select2-search__field";
    public static final String INCOTERM_LOCATION_TEXTFIELD = "#incoTermLocationId";
    public static final String STORAGE_LOCATION = "#select2-storageLocId-container";
    public static final String STORAGE_LOCATION_SEARCH = ".select2-search__field";
    ...
    public static final String ORDER_INTAKE_POC_CATALOG = "//input[@id='orderInTakeId']";
    public static final String ORDER_INTAKE_POC_NONCATALOG = "//input[@id='orderintakeid']";
    public static final String SALES_ORDER_INTAKE = "#orderintakeId";
    public static final String TARGET_PRICE_POC_CATALOG = "//input[@id='targetPriceId']";
    public static final String TARGET_PRICE_POC_NONCATALOG = "//input[@id='targetpriceid']";
    public static final String SALES_TARGET_PRICE = "#targetpriceId";
    public static final String WARRANTY_REQUIREMENTS_POC_CATALOG = "#select2-warrantyRequirementsId-container";
    public static final String WARRANTY_REQUIREMENTS_POC_NONCATALOG = "#select2-warrantyrequirementsid-container";

    public static final String SALES_WARRANTY_REQUIREMENTS = "#select2-warrantyrequirementsId-container";
    public static final String BUYER_GROUP_POC_CATALOG = "#select2-buyerGroupId-container";
    public static final String BUYER_GROUP_POC_NONCATALOG = "#select2-buyergroupid-container";
    public static final String TYPE_OF_PURCHASE_DROPDOWN = "#select2-typeOfPurchaseId-container";
    public static final String BUYER_GROUP_SEARCH = ".select2-search__field";
    public static final String TYPE_OF_PURCHASE_SEARCH = ".select2-search__field";

    public static final String CHECKER = "#select2-checkerId-container";
    ...
    public static final String POC_CATALOG_INSPECTION_REQUIRED = "#inspectRequired";
    public static final String POC_NON_CATALOG_INSPECTION_REQUIRED = "#inspectrequired";
    ...
    public static final String CATALOG_ITEMS_DROPDOWN = "#select2-rcitemId-container";
    ...
    public static final String CATALOG_ITEM_IMPORT_POPUP = "#itemImport";
    public static final String NON_CATALOG_ITEM_IMPORT_POPUP = "#importItem";
    ...
    public static String getPocType(String type) {
        ...
        return "//a[@href='/Procurement/Requisitions/POC_" + type1 + "_Create']";
    }
    ...
    public static String getNonPocPrType(String type) {
