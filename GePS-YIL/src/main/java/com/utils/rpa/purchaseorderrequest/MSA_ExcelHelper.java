...
//TODO Update Sheet 1 (RequesterInput)
            ...
            updateCell(sheet1, 3, 2, "AribaCompleted");
...
//TODO Save Changes
    ...
    public void updateExcelForOtherStatus(String filePath, String status) {
        Workbook workbook = null;
        try {
            try(FileInputStream fileInputStream = new FileInputStream(filePath)){
                if (filePath.endsWith(".xls")) {
...
//TODO Save Changes
            ...
            logger.error("Exception in update excel for other status function: {}", exception.getMessage());
        }
    }
