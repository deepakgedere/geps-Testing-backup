...
public class PoInvChecklistAcceptTest extends BaseTest {
    ...
    public void accept(String referenceId, String transactionId, String uid, String type) {
        try {
            int status = iInvChecklistAccept.accept(referenceId, transactionId, uid, type);
