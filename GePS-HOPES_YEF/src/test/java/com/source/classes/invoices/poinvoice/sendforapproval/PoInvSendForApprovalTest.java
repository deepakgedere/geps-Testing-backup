...
public class PoInvSendForApprovalTest extends BaseTest {
    ...
    public void sendForApproval(String referenceId, String transactionId, String uid, String type){
        try {
            int status = iInvSendForApproval.sendForApproval(referenceId, transactionId, uid, type);
