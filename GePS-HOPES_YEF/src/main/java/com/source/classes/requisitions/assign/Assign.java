...
//TODO Constructor
    ...
    public int buyerManagerAssign(String type, String purchaseType) {
        ...
        try {
            ...
            String buyerManagerMailId="";
            if(type.equalsIgnoreCase("PS")){
                buyerManagerMailId = jsonNode.get("mailIds").get("buyerManagerEmail").asText();
            } else if (type.equalsIgnoreCase("Sales")) {
                buyerManagerMailId = jsonNode.get("mailIds").get("salesBuyerManagerEmail").asText();
            } else if (type.equalsIgnoreCase("SD")) {
                buyerManagerMailId = jsonNode.get("mailIds").get("nonPocBuyerManagerEmail").asText();
            }
            ...
            String assign = "";
            if (type.equalsIgnoreCase("SD") && purchaseType.equalsIgnoreCase("Catalog BOP2/BOP5")) {
