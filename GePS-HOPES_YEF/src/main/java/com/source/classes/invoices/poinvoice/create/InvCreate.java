...
public class InvCreate implements IInvCreate {
    ...
    public int invoiceTypeHandler(String type, String purchaseType) {
        int status = 0;
        try {
            String vendorMailId;
...
//TODO Invoice Document
            ...
            Locator invoiceSelectLocator = page.locator("//tbody[@id='listContainer']//tr[.//span[contains(text(),'" + invoiceTitle.trim() + "')]]//td[2]//a");
            locatorVisibleHandler(invoiceSelectLocator);
