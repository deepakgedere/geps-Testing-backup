...
//TODO Constructor
    ...
    public int sendForApproval(String type, String purchaseType) {
        ...
        try {
            ...
            Locator sendForApprovalButtonLocator;
            if(type.equalsIgnoreCase("SD") || type.equalsIgnoreCase("PS")) {
                sendForApprovalButtonLocator = page.locator(SD_CATALOG_SENDFORAPPROVAL_BUTTON);
                locatorVisibleHandler(sendForApprovalButtonLocator);
            }
            else{
            sendForApprovalButtonLocator = page.locator(SEND_FOR_APPROVAL__BUTTON);
                locatorVisibleHandler(sendForApprovalButtonLocator);
            }
