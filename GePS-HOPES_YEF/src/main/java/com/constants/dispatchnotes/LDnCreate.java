...
public class LDnCreate {
    ...
    public static final String DN_DATE_SELECTION = "//input[@placeholder='Select dates' and not(@type='hidden')]";
    public static final String TODAY = "//div[@class='dayContainer']//span[contains(@class,'today')]";
    public static final String COLLECTION_ADDRESS = "#collectionAddress";
