...
//TODO Update Sheet 1 (Sheet 1)
        ...
        for (int i = 1; i <= itemCount; i++) {
            ...
            //TODO <<Mandatory Field>
            updateCell(sheet1, i, 8, "1B00"); //TODO Sales Organization HK column (index 9)
            //TODO <<Mandatory Field>>
            updateCell(sheet1, i, 9, "YEF"); //TODO Text: Sales Organization HK column (index 10)
            ...
            //TODO <<Mandatory Field>>
            updateCell(sheet1, i, 12, "GV21"); //TODO Sales office HK column (index 13)
            ...
            //TODO <<Mandatory Field>>
            updateCell(sheet1, i, 40, "200078952"); //TODO Payer HK column (index 41)
            ...
            updateCell(sheet1, i, 183, "BOP200" + i); //TODO Overall Status HK column (index 184)
            if(i > 3) {
                updateCell(sheet1, i, 183, "BOP500" + i); //TODO Overall Status HK column (index 184)
            }
            ...
            //TODO <<Mandatory Field>>
            updateCell(sheet1, i, 218, "E009"); //TODO Planned Billing Date HK column (index 219)
