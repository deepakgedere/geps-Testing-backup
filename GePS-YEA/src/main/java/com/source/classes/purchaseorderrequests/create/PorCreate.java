...
//                locatorVisibleHandler(departmentSearchFieldLocator);
...
//                Locator departmentPicSearchFieldLocator = page.locator(DEPARTMENT_PIC_SEARCH_FIELD);
//                locatorVisibleHandler(departmentPicSearchFieldLocator);
//                departmentPicSearchFieldLocator.fill(requesterMailId);
    ...
    public void oneDollarDescription() {
        try {
            String notes = jsonNode.get("purchaseOrderRequests").get("oneDollarDescription").asText();
            Locator oneDollarLocator = page.locator(ONE_DOLLAR_DESCRIPTION);
            locatorVisibleHandler(oneDollarLocator);
            oneDollarLocator.fill(notes);
        } catch (Exception exception) {
            logger.error("Exception in POR One Dollar Description Function: {}", exception.getMessage());
        }
    }
