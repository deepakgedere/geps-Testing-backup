...
public class GetTransactionIdUtil {
    ...
    private GetTransactionIdUtil() {
    }

//TODO Constructor
    public GetTransactionIdUtil(Playwright playwright, PlaywrightFactory playwrightFactory, Page page, ILogin iLogin, JsonNode jsonNode, ObjectMapper objectMapper, ILogout iLogout) {
        this.iLogin = iLogin;
        ...
        this.logger = LoggerUtil.getLogger(GetTransactionIdUtil.class);
        this.objectMapper = objectMapper;
        this.appUrl = jsonNode.get("configSettings").get("appUrl").asText();
    }

    public static void getTransactionIds() {
        try {
...
//                    invTxnList.add(new InvoicePOJOUtil(referenceId, transactionId, uid));
//                }
//            }
