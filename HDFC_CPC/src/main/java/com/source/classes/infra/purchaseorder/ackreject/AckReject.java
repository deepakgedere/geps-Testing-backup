package com.source.classes.infra.purchaseorder.ackreject;
...
import static com.enums.infra.purchaseorders.ackreject.LAckReject.*;
...
public class AckReject implements IAckReject {
    ...
    public AckReject( JsonNode jsonNode, Page page, ILogin iLogin, ILogout iLogout) {
        this.jsonNode = jsonNode;
        this.page = page;
        this.iLogin = iLogin;
        this.iLogout = iLogout;
        this.logger = org.apache.logging.log4j.LogManager.getLogger(AckReject.class);
    }
