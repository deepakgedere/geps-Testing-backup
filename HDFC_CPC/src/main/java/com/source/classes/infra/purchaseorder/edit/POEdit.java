package com.source.classes.infra.purchaseorder.edit;
...
import static com.enums.infra.purchaseorders.edit.LPoEdit.*;
...
public class POEdit implements IPoEdit {
    ...
    //TODO Constructor
    public POEdit(JsonNode jsonNode, Page page, ILogin iLogin, ILogout iLogout) {
