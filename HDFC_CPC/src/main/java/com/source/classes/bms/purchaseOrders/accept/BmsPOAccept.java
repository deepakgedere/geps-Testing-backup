package com.source.classes.bms.purchaseOrders.accept;
...
import static com.enums.bms.purchaseOrders.accept.LBmsPoAccept.*;
...
public class BmsPOAccept implements IBmsPoAccept {
    ...
    public BmsPOAccept(JsonNode jsonNode, Page page, ILogin iLogin, ILogout iLogout) {
        this.jsonNode = jsonNode;
        this.page = page;
        this.iLogin = iLogin;
        this.iLogout = iLogout;
        this.logger = org.apache.logging.log4j.LogManager.getLogger(BmsPOAccept.class);
    }
