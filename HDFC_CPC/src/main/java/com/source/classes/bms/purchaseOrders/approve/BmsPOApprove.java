package com.source.classes.bms.purchaseOrders.approve;
...
import static com.enums.bms.purchaseOrders.approve.LBmsPoApprove.*;
import static com.factory.PlaywrightFactory.attachScreenshotWithName;
import static com.utils.GetRowUtil.getPoRow;

public class BmsPOApprove implements IBmsPoApprove {
    Logger logger;
    JsonNode jsonNode;
    Page page;
    ILogin iLogin;
    ...
    private BmsPOApprove() {
    }

    //TODO Constructor
    public BmsPOApprove(JsonNode jsonNode, Page page, ILogin iLogin, ILogout iLogout) {
        this.jsonNode = jsonNode;
        this.page = page;
        this.iLogin = iLogin;
        this.iLogout = iLogout;
        this.logger = LoggerUtil.getLogger(BmsPOApprove.class);
    }
